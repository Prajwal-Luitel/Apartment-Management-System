...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblHomeBackgroundIcon = new javax.swing.JLabel();
        ...
        pnlHomeMain.setMaximumSize(new java.awt.Dimension(1706, 912));
        pnlHomeMain.setMinimumSize(new java.awt.Dimension(1706, 912));
        pnlHomeMain.setPreferredSize(new java.awt.Dimension(1706, 912));
        pnlHomeMain.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        pnlHomeMain.add(pnlMenu, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
        ...
        pnlHomeMain.add(lblLoginClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(1650, 0, 50, 50));
        ...
        lblFirstLine.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        lblFirstLine.setText("Effortless Management for Modern");
        pnlFacilitiesText.add(lblFirstLine, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));

        lblSecondLine.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        lblSecondLine.setText("Apartments - Where Comfort Meets");
        pnlFacilitiesText.add(lblSecondLine, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, -1, -1));

        lblThirdLine.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        lblThirdLine.setText("Efficiency!");
        pnlFacilitiesText.add(lblThirdLine, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, -1, 20));

        pnlHomeMain.add(pnlFacilitiesText, new org.netbeans.lib.awtextra.AbsoluteConstraints(371, 700, 290, 80));

        lblHomeBackgroundIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/technoComplex/resources/image/background/Home.png"))); // NOI18N
        pnlHomeMain.add(lblHomeBackgroundIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(371, 0, -1, -1));

        getContentPane().add(pnlHomeMain, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
...
//        tenantList.add(new TenantModel((short) 106, "Rita Koirala", (short) 28, "9867890125", "2023-09-30", (short) 106, "Female"));
    ...
    private void lblLoginCloseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblLoginCloseMouseClicked
        int closeSystem = JOptionPane.showConfirmDialog(pnlHomeMain, "Do you want to close the \nTecnho Management System", "Close System", JOptionPane.YES_NO_OPTION);
    ...
    private javax.swing.JLabel lblHomeBackgroundIcon;
