...
/**
 * <b>The ManageTenant GUI contain input field for tenant details and show them
 * in JTable. It allows admin to perform CRUD(Create, Read, Update, Delete)
 * operation on tenant data and facilitates navigation to other related
 * screen.</b>.
 *
 * <p>
 * Features include:</p>
 * <ul>
 * <li>Display and manage tenant details in a tabular format</li>
 * <li>Input field for tenant details</li>
 * <li>Validation in each field</li>
 * <li>View,Add,Update and Delete tenant record</li>
 * <li>Menu bar for easy navigation</li>
 * </ul>
 *
 * <p>
 * This class uses helper utilities class for table operations and validation.
 * For JCalender jar file was used</p>
 *
...
public class ManageTenant extends javax.swing.JFrame {
    ...
    public ManageTenant() {
        ...
        tenantList = new LinkedList<>(tenantList);
        TableUtil.designTable(tblManageTenant);
        TableUtil.loadListDataToTable(tenantList, tblManageTenant);
    }
    ...
    private void initComponents() {
        ...
        pnlManageTenantMain.add(lblClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(1650, 0, 50, 50));
        ...
        lblViewTenantDetails.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblViewTenantDetails.setText("View Tenant Details");
        pnlManageTenantMain.add(lblViewTenantDetails, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 10, 1210, 60));
        ...
        tblManageTenant.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        ...
        if (tblManageTenant.getColumnModel().getColumnCount() > 0) {
            ...
            tblManageTenant.getColumnModel().getColumn(2).setResizable(false);
            tblManageTenant.getColumnModel().getColumn(3).setResizable(false);
            tblManageTenant.getColumnModel().getColumn(4).setResizable(false);
        ...
        pnlManageTenantMain.add(lblMangeFlatTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 340, 1210, 60));
        ...
        pnlManageTenantMain.add(txtFldAge, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 620, 90, 40));

        lblContact.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
        lblContact.setText("Contact");
        pnlManageTenantMain.add(lblContact, new org.netbeans.lib.awtextra.AbsoluteConstraints(1160, 540, -1, -1));

        lblColonContact.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
        lblColonContact.setText(":");
        pnlManageTenantMain.add(lblColonContact, new org.netbeans.lib.awtextra.AbsoluteConstraints(1270, 540, 10, -1));
        pnlManageTenantMain.add(txtFldContact, new org.netbeans.lib.awtextra.AbsoluteConstraints(1320, 530, 290, 40));
        ...
        pnlManageTenantMain.add(txtFldFlatId, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 620, 120, 40));

        lblJoinDate.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
        lblJoinDate.setText("Join Date");
        pnlManageTenantMain.add(lblJoinDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(1160, 440, -1, -1));
        ...
        pnlManageTenantMain.add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 760, 120, 60));
        ...
        pnlManageTenantMain.add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 760, 120, 60));
        ...
        pnlManageTenantMain.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 760, 120, 60));
        ...
        lblErrorMsgTenantId.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        lblErrorMsgTenantId.setForeground(new java.awt.Color(255, 0, 0));
        lblErrorMsgTenantId.setToolTipText("");
        pnlManageTenantMain.add(lblErrorMsgTenantId, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 420, -1, -1));

        lblErrorMsgName.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        lblErrorMsgName.setForeground(new java.awt.Color(255, 0, 0));
        pnlManageTenantMain.add(lblErrorMsgName, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 510, -1, -1));

        lblErrorMsgAge.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        ...
        lblErrorMsgContact.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        lblErrorMsgContact.setForeground(new java.awt.Color(255, 0, 0));
        pnlManageTenantMain.add(lblErrorMsgContact, new org.netbeans.lib.awtextra.AbsoluteConstraints(1160, 510, -1, -1));
        ...
        lblErrorMsgJoinDate.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        lblErrorMsgJoinDate.setForeground(new java.awt.Color(255, 0, 0));
        pnlManageTenantMain.add(lblErrorMsgJoinDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(1160, 420, -1, -1));

        lblErrorMsgGender.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        ...
        pnlManageTenantMain.add(lblReset, new org.netbeans.lib.awtextra.AbsoluteConstraints(1230, 750, -1, -1));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (isValid) {
            ...
            if (checkDuplicateTenant(newTenant)) {
                ...
                clearForm();
                // refresh the table
                TableUtil.addTenantDataToTable(newTenant, tblManageTenant);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (isValid) {
            ...
            // Original flatId
            short originalFlatId = findTenantOriginalFlatId(updateTenant);

            // Check for valid flat Id
            if (originalFlatId != updateTenant.getFlatId() && !checkForAvaiableFlat((short) updateTenant.getFlatId())) {
                return;
            }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        int selectedRow = tblManageTenant.getSelectedRow();
        ...
        if (selectedRow == -1) {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                // Get the tenant's flat ID before deletion
                short flatIdToFree = tenantList.get(selectedRow).getFlatId();
                // Remove the flat from the list
                tenantList.remove(selectedRow);

                // Mark the flat as "Available" in the flat list
                for (FlatModel flat : flatList) {
                    if (flat.getFlatId() == flatIdToFree) {
                        flat.setFlatStatus("Available"); // set the status back to Available
                        break;
                    }
                }
                // Refresh the table
    ...
    private void lblResetMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblResetMouseClicked
        clearForm();
        txtFldTenantId.setBorder(null);
        lblErrorMsgTenantId.setText(null);
        txtFldName.setBorder(null);
        lblErrorMsgName.setText(null);
        txtFldAge.setBorder(null);
        lblErrorMsgAge.setText(null);
        txtFldContact.setBorder(null);
        lblErrorMsgContact.setText(null);
        txtFldFlatId.setBorder(null);
    ...
    /**
     * Finds the original flat ID of a tenant from the tenant list based on the
     * provided tenant details.
     *
     * @param updateTenant The tenant model containing the tenant's updated
     * details.
     * @return The original flat ID if the tenant exists in the list; otherwise,
     * returns -1.
     */
    private short findTenantOriginalFlatId(TenantModel updateTenant) {
        for (TenantModel tenant : tenantList) {
            if (tenant.getTenantId() == updateTenant.getTenantId()) {
                return tenant.getFlatId();
            }
        }
        return -1; // Return -1 if tenant is not found
    }
        ...
        while (i < flatList.size()) {
            if (flatList.get(i).getFlatId() == flatId) {
                ...
                if (flatList.get(i).getFlatStatus().equals("Available")) {
                    ...
                    return ValidationUtil.validateField(
