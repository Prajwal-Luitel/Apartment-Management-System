...
/**
 * <b>The SortAndSearchTenant class represents the GUI screen for sorting and
 * searching tenant record. Tenant data can be sorted by TenantId, Age, Name
 * screen in ascending and descending order. Tenant data can be searched by
 * name</b>.
 *
 * <p>
 * Features include:</p>
 * <ul>
 * <li>Display sorted tenant details in a tabular format</li>
 * <li>Sort by TenantId, Age, Name from JComboBox</li>
 * <li>Button to sort in ascending and descending</li>
 * <li>Validate and search tenant record by name</li>
 * <li>Navigation to various screens</li>
 * </ul>
 *
 * <p>
 * This class uses Selection Sort algorithm for sorting by TenantId and
 * Insertion Sort for Age and Name. Binary Search for searching Name</p>
 *
...
public class SortAndSearchTenant extends javax.swing.JFrame {
    ...
    public SortAndSearchTenant() {
        ...
        TableUtil.designTable(tblSortedTenant);
        TableUtil.designTable(tblTenantSearched);
        TableUtil.loadListDataToTable(sortedTenantList, tblSortedTenant);
    }
    ...
    private void initComponents() {
        ...
        dTenantSearched = new javax.swing.JDialog();
        pnlTenantSearched = new javax.swing.JPanel();
        scrlpnTenantSearched = new javax.swing.JScrollPane();
        tblTenantSearched = new javax.swing.JTable();
        ...
        dTenantSearched.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        dTenantSearched.setTitle("Searched Tenant Data");
        dTenantSearched.setBackground(new java.awt.Color(232, 245, 255));
        dTenantSearched.setMinimumSize(new java.awt.Dimension(970, 344));
        dTenantSearched.getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        pnlTenantSearched.setBackground(new java.awt.Color(232, 245, 255));
        pnlTenantSearched.setMaximumSize(new java.awt.Dimension(970, 344));
        pnlTenantSearched.setMinimumSize(new java.awt.Dimension(970, 344));
        pnlTenantSearched.setPreferredSize(new java.awt.Dimension(970, 344));
        pnlTenantSearched.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        scrlpnTenantSearched.setBackground(new java.awt.Color(0, 255, 204));
        scrlpnTenantSearched.setForeground(new java.awt.Color(255, 255, 255));
        scrlpnTenantSearched.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);

        tblTenantSearched.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblTenantSearched.getTableHeader().setReorderingAllowed(false);
        scrlpnTenantSearched.setViewportView(tblTenantSearched);

        pnlTenantSearched.add(scrlpnTenantSearched, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 870, 210));

        dTenantSearched.getContentPane().add(pnlTenantSearched, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
        ...
        lblMenuManageFlatIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/technocomplex/resources/images/icons/Manage Tenant.png"))); // NOI18N
        ...
        pnlSortAndSearchTenantMain.add(lblClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(1650, 0, 50, 50));

        btnAsceOrDesc.setBackground(new java.awt.Color(102, 153, 255));
        btnAsceOrDesc.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        btnAsceOrDesc.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/technocomplex/resources/images/icons/Ascending.png"))); // NOI18N
        ...
        pnlSortAndSearchTenantMain.add(btnAsceOrDesc, new org.netbeans.lib.awtextra.AbsoluteConstraints(1470, 50, 150, -1));

        cmBxTenantFields.setBackground(new java.awt.Color(102, 153, 255));
        ...
        tblSortedTenant.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        ...
        lblSortedTenantDetails.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblSortedTenantDetails.setText("Sorted Tenant Details");
        pnlSortAndSearchTenantMain.add(lblSortedTenantDetails, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 170, 1210, 60));

        lblSearchIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/technocomplex/resources/images/icons/Search.png"))); // NOI18N
        ...
        txtfldSearch.setText("Search By Name");
        ...
        btnSearch.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
 ...
 /**
    ...
    private void btnAsceOrDescActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAsceOrDescActionPerformed
        // Change the icon after clicking the button
        if (isAscending) {
            btnAsceOrDesc.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/technocomplex/resources/images/icons/Descending.png")));
            btnAsceOrDesc.setText("Descending");
            isAscending = false;

        } else {
            btnAsceOrDesc.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/technocomplex/resources/images/icons/Ascending.png")));
            btnAsceOrDesc.setText("Ascending");
            isAscending = true;
        }
        //Checking for empty list
        if (tenantList.isEmpty()) {
            JOptionPane.showConfirmDialog(pnlSortAndSearchTenantMain, "Cannot sort from empty data.\nSort after filling the data", "Empty Data.", JOptionPane.ERROR_MESSAGE);
            return;
        }
        //Sort the data
    ...
    private void txtfldSearchFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtfldSearchFocusGained
        if (txtfldSearch.getText().equals("Search By Name")) { // User has not entered text yet
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (txtfldSearch.getText().isEmpty() || txtfldSearch.getText().equals("Search By Name")) {
            isValid = ValidationUtil.validateField(
                    txtfldSearch, "Flat ID", lblErrorSearch, "Enter name to search",
                    false);
        } else {
            isValid = ValidationUtil.validateField(
                    txtfldSearch, "Flat ID", lblErrorSearch, "Enter valid name",
                    ValidationUtil.isValidName(txtfldSearch.getText().trim()));
        }
        if (!isValid) {
            return;
        }
        ...
        if (multiplevalue.isEmpty()) {
            // name doesn't exist
            JOptionPane.showMessageDialog(this, "The name doesn't exist\ntry another name", "No Result Found", JOptionPane.WARNING_MESSAGE);
        } else {
            // clear the already existing table data in JDialog
            TableUtil.clearTableData(tblTenantSearched);
            // loading the matched value to Table in JDialog
            for (int i = 0; i < multiplevalue.size(); i++) {
                TableUtil.addTenantDataToTable(sortedTenantList.get(multiplevalue.get(i)), tblTenantSearched);
            }
            dTenantSearched.setVisible(true);
        }
    ...
    private javax.swing.JDialog dTenantSearched;
    ...
    private javax.swing.JPanel pnlTenantSearched;
    private javax.swing.JScrollPane scrlpnSortedTenantTable;
    private javax.swing.JScrollPane scrlpnTenantSearched;
    private javax.swing.JTable tblSortedTenant;
    private javax.swing.JTable tblTenantSearched;
