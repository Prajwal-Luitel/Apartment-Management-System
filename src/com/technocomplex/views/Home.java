...
/**
 * <b>The Home class represents the main GUI screen of the apartment management
 * system. It contain menu which serves as a navigation hub to other screens
 * such as Dashboard, Manage Flats, Manage Tenants, Sort and Search
 * Flats/Tenants, and Cleaning Log.</b>
 *
 * Features include:
 * <ul>
 * <li>Hover effects for better user interaction</li>
 * <li>Navigation to various screens</li>
 * <li>Confirmation dialog for system exit</li>
 * </ul>
 *
 * <p>
...
public class Home extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Home which store default data in flat and tenant lists
     */
    public Home() {
    ...
    /**
     * Creates new form Home populate both list with the data obtained from
     * other JFrame
     *
     * @param flatList flat data list from other JFrame
     * @param tenantList tenant data list from other JFrame
     */
    public Home(List<FlatModel> flatList, List<TenantModel> tenantList) {
    ...
    private void initComponents() {
        ...
        pnlFacilitiesText = new javax.swing.JPanel();
        lblFacilitiesFirstLine = new javax.swing.JLabel();
        lblFacilitiesSecondLine = new javax.swing.JLabel();
        lblFacilitiesThirdLine = new javax.swing.JLabel();
        ...
        pnlHomeScreen.setMaximumSize(new java.awt.Dimension(1706, 912));
        pnlHomeScreen.setMinimumSize(new java.awt.Dimension(1706, 912));
        pnlHomeScreen.setPreferredSize(new java.awt.Dimension(1706, 912));
        ...
        pnlMenu.setMinimumSize(new java.awt.Dimension(371, 912));
        ...
        pnlMenuHome.setBackground(new java.awt.Color(97,97,97,120));
        ...
        pnlHomeScreen.add(pnlMenu, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
        ...
        pnlHomeScreen.add(lblClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(1650, 0, 50, 50));

        pnlFacilitiesText.setBackground(new java.awt.Color(223, 241, 255));
        pnlFacilitiesText.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblFacilitiesFirstLine.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        lblFacilitiesFirstLine.setText("Effortless Management for Modern");
        pnlFacilitiesText.add(lblFacilitiesFirstLine, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));

        lblFacilitiesSecondLine.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        lblFacilitiesSecondLine.setText("Apartments - Where Comfort Meets");
        pnlFacilitiesText.add(lblFacilitiesSecondLine, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, -1, -1));

        lblFacilitiesThirdLine.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        lblFacilitiesThirdLine.setText("Efficiency!");
        pnlFacilitiesText.add(lblFacilitiesThirdLine, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, -1, 20));

        pnlHomeScreen.add(pnlFacilitiesText, new org.netbeans.lib.awtextra.AbsoluteConstraints(371, 700, 290, 80));

        lblHomeBackgroundImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/technoComplex/resources/images/background/Home.png"))); // NOI18N
        pnlHomeScreen.add(lblHomeBackgroundImage, new org.netbeans.lib.awtextra.AbsoluteConstraints(371, 0, -1, -1));

        getContentPane().add(pnlHomeScreen, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
     ...
     * @param menuLabel the menu title label in which underline using border
     * (hover effect) is to be shown
     */
    private void mouseEnter(JPanel menuPanel, JLabel menuLabel) {
        menuPanel.setBackground(null);
        menuPanel.setBackground(new Color(192, 213, 255));
        menuPanel.setOpaque(true);
        menuLabel.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(255, 255, 255)));
    }
     ...
     * @param menuLabel the menu title label to turn it back to normal
     *
     */
    private void mouseExit(JPanel menuPanel, JLabel menuLabel) {
        menuPanel.setBackground(null);
    ...
    /**
     * Handles the mouse Exit event on the Menu Manage Flat panel. Menu DManage
     ...
     *
     * @param evt the event triggered by clicking on the Menu Cleaning Log
     * panel.
     */
    ...
    /**
     * Handles the mouse Exit event on the Menu Dashboard panel. Menu Sort and
     * Search Tenant panel is turned back to normal by removing hover effect.
     *
     * @param evt the event triggered by exiting on the Menu Sort and Search
     * Tenant panel.
     */
    ...
    /**
     * Handles the mouse click event on the Menu Log In panel. Direct the user
     * to Log In screen and dispose this screen.
     *
     * @param evt the event triggered by clicking on the Menu Log In panel.
     */
    ...
    /**
     * Handles the mouse Enter event on the Menu Log In panel. Hover effect on
     * Menu Log In panel is created.
     *
     * @param evt the event triggered by entering on the Menu Log In panel.
     */
    ...
    /**
     * Handles the mouse Exit event on the Menu Log In panel. Menu Log In panel
     * is turned back to normal by removing hover effect.
     *
     * @param evt the event triggered by exiting on the Menu Log In panel.
     */
    ...
    /**
     * Handles the mouse click event on the close label in the Home window.
    ...
    private void lblCloseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblCloseMouseClicked
        int closeSystem = JOptionPane.showConfirmDialog(pnlHomeScreen, "Do you want to close the \nTecnho Management System", "Close System", JOptionPane.YES_NO_OPTION);
    ...
    private javax.swing.JLabel lblFacilitiesFirstLine;
    private javax.swing.JLabel lblFacilitiesSecondLine;
    private javax.swing.JLabel lblFacilitiesThirdLine;
    ...
    private javax.swing.JPanel pnlFacilitiesText;
