...
/**
 * <p>
 * The BinarySearch class provides search on a sorted TenantModel objects list
 * based on tenant name. This class is designed to handle cases where multiple
 * elements in the list may match the search criteria. It efficiently finds all
 * indices of the matching elements in the list and return them in a list.
 * </p>
 *
 * <p>
 * Key Features:
 * <ul>
 * <li>Binary search algorithm implementation for efficient searching in sorted
 * lists.</li>
 * <li>Ability to find multiple occurrences of a search value and return their
 * indices.</li>
 * <li>Case-insensitive comparison to handle variations in the search string's
 * casing.</li>
 * </ul>
 * </p>
 * <p>
 * Preconditions: The input list must be sorted in ascending order by the name
 * field of the TenantModel objects.
 * <p>
 *
